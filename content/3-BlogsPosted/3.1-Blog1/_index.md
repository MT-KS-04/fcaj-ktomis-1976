...
_Note that GameLift is only responsible for managing and allocating servers. Once the player receives the IP address and connection port, gameplay traffic goes directly between the Game Client and the Dedicated Game Server, bypassing GameLift entirely to minimize latency._

...
_Điểm đáng chú ý là GameLift chỉ chịu trách nhiệm quản lý và cấp phát máy chủ. Sau khi người chơi nhận được địa chỉ IP và cổng kết nối, dữ liệu gameplay sẽ được truyền trực tiếp giữa Game Client và Dedicated Game Server, không đi qua GameLift để giảm thiểu độ trễ tối đa._
